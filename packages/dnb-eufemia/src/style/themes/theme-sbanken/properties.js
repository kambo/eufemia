...
export default {
  ...
  '--sb-font-size-medium': '2.125rem',
  '--sb-font-size-large': '2.625rem',
  ...
  '--sb-line-height-lead': '2.5rem',
  '--sb-line-height-medium': '3rem',
  '--sb-line-height-large': '3rem',
  '--sb-line-height-x-large': '3.125rem',
  '--sb-color-black': '#000',
