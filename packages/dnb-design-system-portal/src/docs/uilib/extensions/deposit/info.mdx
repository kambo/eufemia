...
The goal of the Deposit extension is to make it easy to build forms and other data input features in DNB applications built with React.
...
The components in Deposit are data-driven. This means that they are built on the premises of the source data.
