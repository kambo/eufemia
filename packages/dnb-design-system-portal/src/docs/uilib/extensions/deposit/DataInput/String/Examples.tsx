...
// import { Button, Tabs, Section, P, Anchor } from '@dnb/eufemia/src'
  ...
  return (
    <ComponentBox scope={{ DataInput }}>
      <DataInput.String
        ...
        label="Label text"
        onChange={(value) => console.log('onChange', value)}
        warning={new Error("I'm warning you...")}
      />
    </ComponentBox>
  )
}
  ...
  return (
    <ComponentBox scope={{ DataInput }}>
      <DataInput.String
        ...
        validator={(value) =>
          value.length < 4 ? new Error('At least 4 characters') : undefined
        }
        onChange={(value) => console.log('onChange', value)}
      />
    </ComponentBox>
          ...
          new Promise((resolve) =>
            setTimeout(
              () =>
                resolve(
                  value.length < 5
                    ? new Error('At least 5 characters')
                    : undefined
                ),
              1500
            )
