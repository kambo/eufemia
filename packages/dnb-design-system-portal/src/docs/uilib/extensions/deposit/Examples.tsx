...
export const BaseFieldComponents = () => {
  return (
    <ComponentBox scope={{ DataContext, Layout, StepsLayout, DataInput, DataValue, Visibility }}>
      <DataInput.String
        label="Text field"
        value="Lorem Ipsum"
  ...
  return (
    <ComponentBox scope={{ DataContext, Layout, StepsLayout, DataInput, DataValue, Visibility }}>
      ...
      >
        ...
        <DataInput.Boolean path="/advanced" variant="toggle-checkbox" label="More fields" />
    ...
    <ComponentBox scope={{ DataContext, Layout, StepsLayout, DataInput, DataValue, Visibility }}>
      ...
      >
        ...
        <Layout.Card stack>
          ...
          <DataInput.NationalIdentityNumber path="/ssn" validateInitially />
